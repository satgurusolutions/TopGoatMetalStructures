...
const schema = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://www.topgoatmetalstructures.com/rent-to-own-metal-buildings/',
      url: 'https://www.topgoatmetalstructures.com/rent-to-own-metal-buildings/',
      ...
      description:
        'Find the best rent-to-own metal buildings, carports, and garages at affordable prices with no hard credit checks. Enjoy flexible RTO all steel structures with quick approval.',
      breadcrumb: {
        '@id': 'https://www.topgoatmetalstructures.com/rent-to-own-metal-buildings/#breadcrumb',
      },
      inLanguage: 'en-US',
      potentialAction: [
        {
          '@type': 'ReadAction',
          target: ['https://www.topgoatmetalstructures.com/rent-to-own-metal-buildings/'],
        },
      ],
    },
    {
