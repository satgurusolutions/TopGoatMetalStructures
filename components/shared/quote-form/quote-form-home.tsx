...
export default function QuoteFormHomeComponent({ isMilitary }: Readonly<{ isMilitary?: boolean }>) {
  ...
  const form = useForm<QuoteFormValues>({
    ...
    defaultValues: {
      ...
      Notes: '',
      LeadSource: 'Website RTO Home Form',
      MilitaryBranch: 'Navy',
      Terms: false,
      BuildingStyleOther: '',
    },
  ...
  return (
    <form
      className="mx-auto space-y-6 px-4 xl:max-w-5xl xl:px-0"
    ...
    >
      ...
      {/* Building Type */}
      <div>
        <Label className="mb-2 block text-sm font-semibold text-[#D2D2D5]">
          Choose one from here <span className="text-red-600">*</span>
        </Label>
        <Controller
          name="BuildingStyle"
          control={form.control}
          render={({ field }) => (
            ...
            >
              <SelectTrigger
                className={`h-12! w-full rounded-[38px] px-4 text-xs md:text-sm lg:text-sm ${
                  open || field.value ? 'text-[#D2D2D5]' : ''
                }`}
              >
              ...
              render={({ field }) => (
                <div>
                  <Input
                    ...
                    className="h-12 rounded-[38px] px-4 text-sm lg:text-sm"
                    {...field}
                  />
      ...
      {/* Building Dimensions */}
      <div>
        <Label className="mb-2 block text-sm font-semibold text-[#D2D2D5] lg:text-sm">
            ...
            render={({ field }) => (
              <div>
                <div className="relative">
                  ...
                  <Input
                    placeholder="Width"
                    className="h-12 rounded-[38px] px-4 pl-10 text-sm lg:text-sm"
                    {...field}
                  />
                </div>
          ...
          <Controller
            ...
            render={({ field }) => (
              <div>
                ...
                >
                  <SelectTrigger
                    className={`h-12! w-full rounded-[38px] px-4 text-xs md:text-sm lg:text-sm ${isStateOpen || field.value ? '' : 'text-[#777980]'}`}
                  >
      ...
      {/* Building Notes */}
      <div>
        <Label className="mb-2 block text-sm font-semibold text-[#D2D2D5]">Building Notes</Label>
        <Controller
          name="Notes"
          control={form.control}
          render={({ field }) => (
            <div>
              <Textarea
                ...
                className="min-h-[80px] rounded-[32px] px-4 text-sm lg:text-sm"
                {...field}
              />
