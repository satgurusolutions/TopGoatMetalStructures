...
export default function QuoteFormSmall({
  isMilitary,
  leadSourceName,
  ...
  const options = [
    { value: '0–3 Months (Urgent)', label: 'Urgent' },
    { value: '3–6 months (Near Future)', label: '3-6 Months' },
    { value: '6 Months+  (Planning Stage)', label: '6 Months+' },
  ];
      ...
      const body = {
        form: {
          ...
          LeadSource: isMilitary
            ...
            : leadSourceName || 'Website Get a Quote Form',
  ...
  return (
    ...
    >
              ...
              >
                {militaryBranches.map((opt) => (
                  <div
                    ...
                    //   onClick={() => setBuyingTime(opt.value)}
                  >
                    <RadioGroupItem
                      value={opt.value}
                      id={opt.value}
      ...
      <div>
        ...
        {buildingStyle === 'Other' && form?.formState?.errors?.BuildingStyleOther && (
          <p className="mt-1 text-xs text-red-500 lg:text-sm">
      ...
      {/* Building Dimensions */}
      <div>
        <Label className="mb-2 block text-base font-semibold lg:text-base">
            ...
            render={({ field }) => (
              <div>
                <div className="relative">
                  ...
                  <Input placeholder="Width" className="h-10 px-4 pl-10" {...field} />
                </div>
            ...
            render={({ field }) => (
              <div>
                <div className="relative">
                  ...
                  <Input placeholder="Length" className="h-10 px-4 pl-10" {...field} />
                </div>
            ...
            render={({ field }) => (
              <div>
                <div className="relative">
                  ...
                  <Input placeholder="Height" className="h-10 px-4 pl-10" {...field} />
                </div>
      ...
      {/* Buying Time */}
      <div>
        <Label className="block text-base font-semibold">When do you plan to build?</Label>
        <Controller
          name="BuyingTime"
          control={form.control}
          render={({ field }) => (
            ...
            >
              {options.map((opt) => (
                <div
                  key={opt.value}
                  className={cn(
                    'flex cursor-pointer items-center space-x-2 rounded-full pt-2 transition-colors duration-200',
                  )}
                >
                  <RadioGroupItem
                    value={opt.value}
          ...
          render={({ field }) => (
            <div>
              <Textarea
                ...
                className="min-h-16 rounded-[32px] px-4"
                {...field}
              />
        ...
        <div className="mb-8 block text-lg font-semibold italic">
          *Accepted Documentation: DD214, OMPF, Government issued ID with combat veteran component,
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <Label className="mt-2 block text-lg" htmlFor="terms">
